          ...
          <div className="lg:col-span-2">
            <Card className="shadow-elegant">
              ...
              <CardContent className="space-y-6">
                {/* Netlify Forms: envia as informações do formulário através do Netlify */}
                <form
                  name="contact"
                  method="POST"
                  data-netlify="true"
                  ...
                  action="/obrigado"
                >
                  {/* identifica o formulário para o Netlify */}
                  <input type="hidden" name="form-name" value="contact" />
                  {/* honeypot anti-spam (não remova o name="bot-field") */}
